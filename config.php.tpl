...
class Webgrind_Config extends Webgrind_MasterConfig {
     ...
     */
    static $storageDir = '{{ getenv "WEBGRIND_STORAGE_DIR" "" }}';
    static $profilerDir = '{{ getenv "WEBGRIND_PROFILER_DIR" "/tmp" }}';
    ...
    static $defaultTimezone = '{{ getenv "WEBGRIND_DEFAULT_TIMEZONE" "Europe/Copenhagen" }}';
